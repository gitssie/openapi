...
public class EbeanExpressionList<T> implements SpiExpressionList<T> {
     ...
     */
    public EbeanExpressionList(ExpressionFactory expr) {
        this(null, expr, null, new ArrayList<>(), true);
    }

    public EbeanExpressionList(ExpressionFactory expr, ExpressionList<T> parentExprList) {
        this(null, expr, parentExprList);
    }

    EbeanExpressionList(Query<T> query, ExpressionFactory expr, ExpressionList<T> parentExprList) {
        this(query, expr, parentExprList, new ArrayList<>());
    }

    EbeanExpressionList(Query<T> query, ExpressionFactory expr, ExpressionList<T> parentExprList, List<SpiExpression> list) {
        this(query, expr, parentExprList, list, false);
    }

    private EbeanExpressionList(Query<T> query, ExpressionFactory expr, ExpressionList<T> parentExprList, List<SpiExpression> list, boolean textRoot) {
     ...
     * </p>
     */
    public EbeanExpressionList<T> copy(Query<T> query) {
        EbeanExpressionList<T> copy = new EbeanExpressionList<>(query, expr, null);
        copy.list.addAll(list);
        return copy;
    }

    @Override
    public EbeanExpressionList<T> copyForPlanKey() {
        EbeanExpressionList<T> copy = new EbeanExpressionList<>();
    ...
    public boolean isSameByBind(SpiExpression other) {
        EbeanExpressionList<?> that = (EbeanExpressionList<?>) other;
