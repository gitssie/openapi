...
public class EntityFieldEditForm {
    @Size(max = 128)
    ...
    private Boolean nullable;//    Boolean           DEFAULT TRUE,
    private Boolean required;//    Boolean           DEFAULT FALSE COMMENT '是否必填',
    private Boolean creatable;//  Boolean           DEFAULT TRUE ,
    private Boolean updatable ;//  Boolean           DEFAULT TRUE ,
    private Boolean sortable ;//    Boolean           DEFAULT TRUE COMMENT '是否可以进行排序',
