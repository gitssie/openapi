...
import com.gitssie.openapi.ebean.repository.EbeanJdbcRepositoryFactoryBean;
import com.gitssie.openapi.ebean.repository.EbeanRepositoriesRegistrar;
...
public @interface EnableEbeanRepositories {
	 ...
	 */
	Class<?> repositoryFactoryBeanClass() default EbeanJdbcRepositoryFactoryBean.class;
